...
CATEGORY_REASONS = {
    "rojo": "Regla: ultraprocesado/alto en azúcar o frito ⇒ rojo.",
    "amarillo": "Regla: fuente moderada de carbohidratos/porción ⇒ amarillo.",
    "verde": "Regla: bebida/comida sin azúcar añadida o verduras ⇒ verde.",
}
